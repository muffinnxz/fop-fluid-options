  ...
  async function sfcreatflow() {
    ...
    try {
      const createFlowOperation = sf.cfaV1.createFlow({
        ...
        flowRate: ethers.BigNumber.from(optionData.requiredFlowRate).toString(),
        superToken: DAIx,
        // userData?: string
      });
  ...
  return (
    <div className={styles.option_detail_page}>
      ...
      >
        ...
        <div className={styles.option_detail_card}>
          <div className={styles.option_detail_card_title}>Strike Asset</div>
          <div className={styles.option_detail_card_value}>
      ...
      >
        ...
        <div className={styles.option_detail_card}>
          <div className={styles.option_detail_card_title}>Strike Price</div>
          <Tooltip
            title={(
      ...
      >
        {isConnected ? (
          isLoading || !underlyingAllowance || !flowRateInfo ? (
            <Blocks
              visible={true}
              height="80"
              width="80"
            ...
            <div style={{ minWidth: "60%" }}>
              {optionData.receiver === address ? (
                underlyingAllowance >= optionData.underlyingAmount ||
                optionData.optionActive ? (
                  <div style={{ textAlign: "center" }}>
                    You already approve sufficient amount of the underlying
                    asset ({goerliTokenName[optionData.underlyingAsset]})
                  </div>
                ) : (
                  <div style={{ textAlign: "center" }}>
                    <Button
                  ...
                  {flowRateInfo &&
                    ethers.BigNumber.from(flowRateInfo.flowRate) > 0 && (
                      ...
                      >
                        ...
                        >
                          <div>
                            Total {goerliTokenName[optionData.flowAsset]} flow:
                          </div>
                          <div>
                            {(
                        ...
                        >
                          <div>
                            Current {goerliTokenName[optionData.flowAsset]} flow
                            / day:
                          </div>
                          <div>
                            {(
            ...
            <div>Option is not ready, already closed, or expire!</div>
          )
        ) : (
