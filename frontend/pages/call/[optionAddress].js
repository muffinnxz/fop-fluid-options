...
export default function User() {
  ...
  const exerciseOption = async () => {
    ...
    try {
      ...
      let tx = await fDAI.approve(router.query.optionAddress, strikePrice);
      await tx.wait();
  ...
  return (
    <div className={styles.option_detail_page}>
      ...
      >
        {isConnected &&
          (isLoading || !optionData || !underlyingAllowance || !flowRateInfo ? (
            <Blocks
              visible={true}
              height="80"
              width="80"
                  ...
                  {flowRateInfo &&
                    ethers.BigNumber.from(flowRateInfo.flowRate) > 0 && (
                      ...
                      >
                        ...
                        >
                          <div>
                            Owed {goerliTokenName[optionData.flowAsset]} Flow:
                          </div>
                          <div>
